...
class BigRoom extends StatelessWidget {
  BigRoom({super.key});
  ...
  final List<Description> descriptions = [
    Description(
        ...
        title: 'Description',
        subtitle:
            '1 big hall room for rent at lalitpur, ktm with the facilities of bike parking and tap water. It offers 1 bedroom, and a common bathroom for whole flat.It is suitable for student only.Price is negotiable for students only'),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    //                 Text(descriptions[index].subtitle)
    //               ]),
    //             )
    //           ],
    //         );
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Stack(children: [
                      ClipRRect(
                        borderRadius: BorderRadius.circular(20),
                        child: Image.network(rooms[index].imageUrl),
                      ),
                      Positioned(
